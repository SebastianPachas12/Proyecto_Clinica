...
@WebServlet(name = "ControlBuscarHistoria", urlPatterns = {"/ControlBuscarHistoria"})
public class ControlBuscarHistoria extends HttpServlet {
        ...
        String accion = request.getParameter("accion");
            switch (accion){
                case "Buscar":
                    ...
                    List listar = servBuscarHistoria(dni);
                    request.setAttribute("histo", listar);
